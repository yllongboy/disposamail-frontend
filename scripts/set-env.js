 ...
 *   NG_BANNER_ENABLED       Status banner visibility     default: false
 *   NG_BANNER_MESSAGE       Status banner message        default: (empty)
 *   NG_BANNER_TYPE          Status banner type           default: info
 */
...
const bannerEnabled = env('NG_BANNER_ENABLED', 'false') === 'true';
...
export const environment = {
  ...
  banner: {
    ...
    message: '${s('NG_BANNER_MESSAGE', '')}',
    type: '${s('NG_BANNER_TYPE', 'info')}' as 'info' | 'warning' | 'success',
  },
};
`;
